...
console.log('== production surfaces remain inert in Phase 1 ==');
...
ok(state.state === 'EXECUTION_INFRASTRUCTURE_INCOMPLETE', 'production authorization stays fail-closed until Phase 2 records hashes and execution HEAD');
